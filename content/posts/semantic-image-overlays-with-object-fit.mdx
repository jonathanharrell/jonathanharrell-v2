...
<article class="blog-post-teaser">
  ...
  <div class="overlay">
    <h3>
      <a href="/post-url">Article Title</a>
    </h3>
  </div>
</article>
```
...
<aside>
  <p><a href="https://www.w3.org/TR/css-images-3/#the-object-fit" target="_blank" aria-label="Learn more about the object-fit property">Learn more</a> about the <code>object-fit</code> property</p>
</aside>
...
<aside>
  <p>Check out the <a href="https://caniuse.com/object-fit" target="_blank" aria-label="Check out the browser support for object-fit">browser support</a> for <code>object-fit</code></p>
</aside>
