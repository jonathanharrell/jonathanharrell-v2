---
templateKey: post
slug: implicit-state-sharing-in-react-vue
...
<figure>
  <img src="../../assets/accordion-state-sharing.png" alt=""/>
</figure>
...
<aside>
  <p>This is a small aside with notes about the article</p>
</aside>
...
Vue.component('accordion-header', {
  ...
  template: `
    <h2 class="accordion-header">
      <button
        @click="accordionItemState.expanded = !accordionItemState.expanded"
      >
...
Vue.component('accordion-panel', {
  ...
  template: `
    <div
      ...
      :class="{
        expanded: accordionItemState.expanded
      }"
    >
      <slot></slot>
    </div>
