...
<figure className="lg:-ml-24 lg:-mr-24">
  <img src="../../assets/live-theming.svg" alt=""/>
...
CSS variables make live theming a piece of cake. Check out the [live experiment here](https://codepen.io/jonathanharrell/details/EdawEq). In a real-world app, you would probably want to store the theme options in user settings on the back-end. Hopefully this gets you started playing around with the fun things that CSS variables make possible.
