...
<aside>
  <p>Read the HTML Spec to <a href="https://html.spec.whatwg.org/multipage/sections.html#the-aside-element" target="_blank" aria-label="learn more about the aside element">learn more</a> about the <code>aside</code> element.</p>
</aside>
...
<aside>
  <p><a href="https://www.w3.org/TR/css3-values/#ch" target="_blank" aria-label="Learn more about the ch unit in CSS">Learn more</a> about the <code>ch</code> unit in CSS.</p>
</aside>
...
<aside>
  <p><a href="https://www.w3.org/TR/css-conditional-3/#at-supports" target="_blank" aria-label="Learn more about the @supports query">Learn more</a> about the <code>@supports</code> query.</p>
</aside>
