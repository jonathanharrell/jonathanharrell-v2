...
<figure>
  ...
  <figcaption>A basic twelve-column grid.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>The post header and content placed on the grid. Each post child implicitly creates a new grid row.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>The aside element positioned on the grid.</figcaption>
</figure>
...
<figure>
  ...
  <figcaption>A full-width figure, retaining a narrow figcaption.</figcaption>
</figure>
