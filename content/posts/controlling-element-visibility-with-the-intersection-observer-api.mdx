...
<figure>
  <img src="../../assets/root-margin.png" alt=""/>
  <figcaption>The root margin grows or shrinks from each side of the root element’s bounding box before computing intersections.</figcaption>
</figure>
...
<figure>
  <img src="../../assets/thresholds.png" alt=""/>
  <figcaption>Thresholds indicate at what percentage of the target’s visibility the observer’s callback should be executed.</figcaption>
</figure>
